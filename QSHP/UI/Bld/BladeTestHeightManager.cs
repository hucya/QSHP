...
{
    public partial class BladeTestHeightManager : BaseForm
    {
        string format = "0.###";
        ...
        int mode = 0;
        TabData tabData;
        public BladeTestHeightManager()
        {
            InitializeComponent();
        }

        public BladeTestHeightManager(int m= 0)
        {
            InitializeComponent();
            if (m > 2)
            {
        ...
        public void LoadTestData(bool show=false)
        {
            ...
            bldNum.Text = Globals.BldData.BldNum;
            bldMode.Text = Globals.BldData.BldModel;
