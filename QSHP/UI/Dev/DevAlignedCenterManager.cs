...
namespace QSHP.UI
{
    public partial class AlignedCenterManager : AlignFormBase
    {
        ...
        private void AlignedCenterManager_Load(object sender, EventArgs e)
        {
            ...
            centerPos = Globals.HighCCD ? new PointF(Globals.DevData.HighCenterX,Globals.DevData.HighCenterY): new PointF(Globals.DevData.LowCenterX, Globals.DevData.LowCenterY);
        ...
        private void AlignedCenterManager_CancelClick(object sender, EventArgs e)
        {
            if (saved)
            {
        ...
        private void AlignedCenterManager_ConfirmClick(object sender, EventArgs e)
        {
            if (repairSucessful)
            {
                ...
                if (Globals.HighCCD)
                {
                    Globals.DevData.LowCenterX = centerPos.X;
                    Globals.DevData.LowCenterY = centerPos.Y;
                }
                else
                {
                    Globals.DevData.HighCenterX = centerPos.X;
                    Globals.DevData.HighCenterY = centerPos.Y;
                }
                saved = true;
            ...
            {
                Common.ReportCmdKeyProgress(CmdKey.P0311);
            }
        }
        ...
        private void AlignedCenterManager_BT1Click(object sender, EventArgs e)
        {
            ...
            {
                float arc = arc2 - arc1;
                centerPos = RotateMath.RotateCenterPoint(p1, p2, arc);
                posFlag = 0;
